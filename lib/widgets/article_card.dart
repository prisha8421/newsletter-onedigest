        ...
        children: [
          if (widget.article.imageUrl.isNotEmpty)
            ClipRRect(
              ...
              child: Image.network(widget.article.imageUrl, height: 200, width: double.infinity, fit: BoxFit.cover),
            ),
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(widget.article.title, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
